...
- Provide a data processing agreement to the ICB.
- Document all data flows and storage locations.
- Prepare for review by the ICB IG team.

### Technical Integration

- Set up API integration with existing GP systems (EMIS/SystmOne).
- Map the data: patient demographics, referral pathways, community services.
- Stand up a test environment.
- Define failover and escalation protocols.
...
Finalise all metrics and the case study. Prepare an expansion proposal with an ROI model. Schedule a final review with all stakeholders. Pre-build a board paper insert for ICB decision-makers.
...
|---|---|---|
| Referrals processed per week | 2x baseline | Weekly |
| Patient contact within 48 hours | 90%+ | Weekly |
| Referral completion rate | 60-70% | Monthly |
| GP appointment reduction | 15-20% | Monthly |
| Patient well-being improvement | 70%+ | End of pilot |
| Staff satisfaction (NPS) | Positive trend | Monthly |
| Cost per referral | 50% reduction | End of pilot |
