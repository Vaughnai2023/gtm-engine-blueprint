...
ICBs (Integrated Care Boards) control NHS budgets at a regional level. PCNs (Primary Care Networks) are groups of GP practices that work together. These are the decision-makers with both the pain and the budget.
...
- **Pain**: Budget cuts meeting rising demand, need to demonstrate prevention ROI
- **Triggers**: Budget planning cycles (Q4/Q1), new public health strategies published
...
- 20-28% GP appointment reduction (reference pilot)
- 60-70% attendance rates on referrals
- 78-88% patient well-being improvement
- £14M in healthcare savings generated
- 5,500 referrals processed weekly across network
...
- Weeks 3-4: 10-15 emails/day to perfect-fit accounts, 2-3 inboxes
- Month 2: 25-40 emails/day across 4-5 inboxes
- Month 3: 50-75 emails/day across 6-8 inboxes
- LinkedIn: 15-20 connection requests/day + 5-10 DMs/day
...
- Leave room to re-engage different contacts in 60 days
...
{{firstName}}, I'll assume the timing isn't right.
...
Key events: NHS ConfedExpo, Social Prescribing Network conferences, NASP events, ICB roundtables, PCN forums.

Attend, speak where possible, capture contacts, follow up within 24 hours via email + LinkedIn + WhatsApp.
...
LinkedIn content creates awareness + captures engagement signals
    |
    v
Signals feed outbound targeting (warm prospects get priority sequences)
    |
    v
...
Demo insights fuel better content (objections become posts)
    |
    v
Wins become case studies -> more content -> more signals -> cycle accelerates
    |
    v
WhatsApp maintains warm relationships between formal touchpoints
```
...
```
("social prescribing" OR "link worker" OR "community connector" OR "personalised care")
AND ("capacity" OR "backlog" OR "waiting list" OR "workforce" OR "digital" OR "AI"
     OR "automation" OR "transformation" OR "recruit" OR "retain")
NOT ("job alert" OR "congratulations" OR "thrilled to announce" OR "proud to share"
     OR "NHS Jobs")
```
...
### Phase 1 (Weeks 1-4, ~£200-300/month)

| Layer | Tool | Cost | Purpose |
|---|---|---|---|
| Data | Clay Explorer | ~£100/mo | Enrichment, scoring, personalisation |
| Orchestration | n8n (self-hosted or cloud) | Free-£20/mo | Workflow automation, signal routing |
| Delivery | Instantly Growth | ~£80/mo | Email sending, warmup, inbox rotation |
| CRM | HubSpot Free | £0 | Pipeline tracking, deal management |
| LinkedIn | Native | £0 | Content + manual outreach |
| AI Orchestration | Claude Code Pro | ~£20/mo | Campaign deployment, copy generation |

### Phase 2 (Month 2+, add as needed)

| Tool | Cost | Purpose |
|---|---|---|
| HeyReach | ~£80/mo | LinkedIn automation at scale |
| Trigify | ~£50/mo | LinkedIn engagement signal capture |
| Shield | ~£20/mo | LinkedIn analytics |
...
Demo -> Champion Identified (60%)
    |
    v
Champion -> Internal Socialisation Complete (50%)
    |
    v
Socialisation -> IG/Procurement Approved (40%)
    |
    v
Approved -> Pilot Signed (70%)
```

**Working backwards from 3-5 pilots:**
- Need 4-6 IG-approved opportunities
- Need 10-15 socialised opportunities
- Need 20-30 champions
- Need 35-50 demos
...
- **Blended target for Day 90**: 2-3 pilots signed (via warm path) + 10-15 champions actively socialising (via cold outbound)
...
|---|---|---|
| Emails sent/day | 50-75 (by Month 2) | Daily |
| Open rate | 45%+ | Weekly |
| Reply rate (positive) | 5-8% | Weekly |
| LinkedIn connections sent/week | 75-100 | Weekly |
| LinkedIn DM reply rate | 15-20% | Weekly |
| Demos booked/month | 15-20 | Weekly |
| Champions identified | 6-10 by Day 60 | Monthly |
| Pilots signed | 2-3 by Day 90 | Monthly |
| Pilot health score | Green for all active pilots | Weekly |
| Content posts/week | 5-8 (founder + GTM lead) | Weekly |
| Content engagement rate | 3%+ | Weekly |
| Pipeline value | £200K+ by Day 90 | Monthly |
| Signal-to-outreach time | <24 hours for Tier 1 | Weekly |

---

## 30/60/90 Day Execution Roadmap

### Days 1-30: Foundation + Warm Outbound + Infrastructure
...
**Week 2:**
- Execute 5-8 warm introductions via the existing network. Book first demos.
- Write 4 email sequences (workforce gap, cost, outcomes, mandate). Load as drafts.
- Start founder LinkedIn content cadence (3 posts/week minimum).
- Deploy signal monitoring workflows (WF-NHS-Jobs-Monitor + WF-Board-Paper-Monitor + WF-Reply-Handler).
- Join 2-3 NHS/social prescribing WhatsApp communities.
...
- Deploy competitive intelligence workflows (competitor contracts + leadership appointments).
...
### Days 61-90: Optimise + Systematise + First Pilots Live

- Scale outbound to 50-75 emails/day.
- Deploy pilot lifecycle workflows for signed pilots.
- Document winning playbook: sequences, angles, channels that convert.
- Build proposal/pricing template based on early objections.
...
- **Per-PCN subscription** (matches how buyers think)
- **Pilot pricing**: 50% discount for first 90 days (£5K-15K per pilot)
- **Full contract**: £30K-100K/year per ICB (depending on PCN count)
- Tie renewal to measured outcomes (appointment reduction, referral completion rates)
- Annual contracts with quarterly reviews
- Expansion pricing scales with PCN count within ICB

---

## NHS Sales Cycle Accelerators
...
- Pipeline value £200K+?
- Winning playbook documented? SDR hire criteria defined?
- Pilot health dashboards showing green?
